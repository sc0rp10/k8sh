...
class TestCdNestedPaths(unittest.TestCase):
    """Test the cd command with nested paths"""
    ...
    def test_cd_dash_workflow(self):
        ...
        with patch.object(State, 'get_current_path') as mock_get_current_path:
            with patch.object(State, 'get_previous_path') as mock_get_previous_path:
                with patch.object(Manager, 'set_path') as mock_set_path:
                    ...
                    self.assertEqual(self.state.previous_path, "default")  # Previous should now be 'default'
                    ...
                    self.assertEqual(self.state.previous_path, "")  # Previous should now be root (empty)
