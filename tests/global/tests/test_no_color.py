...
class TestNoColor(unittest.TestCase):
    ...
    def test_no_color_flag(self):
        ...
        self.assertIn("\033[", output_with_color, "Colored output should contain ANSI escape sequences")

        # Check that the non-colored output does not contain ANSI escape sequences
        self.assertNotIn("\033[", output_no_color, "Non-colored output should not contain ANSI escape sequences")
